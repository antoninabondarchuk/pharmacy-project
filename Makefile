...
test: ## Run tests
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec web invoke tests

testfile: ## Run testfile
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec web invoke testfile $(c)

lint: ## Run linter for app folder
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec web invoke prospector
...
exec: ## Exec container
	docker-compose -f $(or $(DOCKER_COMPOSE_FILE), docker-compose.yml) exec $(or $(c), web) sh
